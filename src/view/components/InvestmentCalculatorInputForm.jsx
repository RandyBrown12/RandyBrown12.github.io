...
const InvestmentCalculatorInputForm = () => {
    ...
    return ( 
        ...
        <form className="form__bg calculateForm spacing">
          ...
          <input value={hours} onChange={e => hoursUpdate(e)} type="text" className="center removeHover form__input" maxlength="3"
            placeholder="Ex: 15" />
          <label for="salary" className="textCenter wrap">
            Expected Salary before taxes:
          </label>
          <div className="center">
            <input value={salary} onChange={e => salaryUpdate(e)} type="text" className="center removeHover form__input" maxlength="9" placeholder="Ex: 60000" />
            <select
